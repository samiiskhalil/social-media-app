...
<StickyBox className='sticky-nav' style={{ top:'0px'}}  >
<nav  className=' shadow navbar navbar-expand-xxl bg-light '>
...
<svg className='app-icon bi bi-stars"' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black"  viewBox="0 0 16 16">
  ...
  <div  className="collapse navbar-collapse" id="navCollapse">
    <div className="navbar-nav">
      <Link to={`/users/${Cookies.get('userId')}`} className="dropdown-link nav-link">
...
<p>{Cookies.get('userName')}</p>
      ...
      <Link to='/logout' className="dropdown-link nav-link">
